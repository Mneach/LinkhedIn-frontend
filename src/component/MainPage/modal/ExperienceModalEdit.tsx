...
import { mutationUpdateExperience } from '../../../lib/graphql/UpdateQuery'
import { toastError, toastSuccess } from '../../../lib/toast/toast'
import { enumCountryType, enumEmploymentType, enumIndustryType, enumMonthType, setBoolean } from '../../../model/FormModel'
import { EducationType, ExperienceType } from '../../../model/model'

const ExperienceModalEdit = ({ modalExperience, setModalExperience, experienceUser }: { modalExperience: boolean, setModalExperience: setBoolean, experienceUser: ExperienceType }) => {


    const UserContext = useUserContext()
    const [experienceUpdateMutation, { loading, error, called }] = useMutation(mutationUpdateExperience)

    const [experienceData, setExperienceData] = useState({
        id: experienceUser.id,
        userId: experienceUser.userId,
        title: experienceUser.title,
        employmentType: experienceUser.employmentType,
        companyName: experienceUser.companyName,
        country: experienceUser.country,
        city: experienceUser.city,
        isActive: experienceUser.isActive,
        industry: experienceUser.industry,
        monthStartDate: experienceUser.monthStartDate,
        monthEndDate: experienceUser.monthEndDate,
        yearStartDate: experienceUser.yearStartDate,
        yearEndDate: experienceUser.yearEndDate,
    })
        ...
        if (!error) {
            if (called && !loading) {
                UserContext.userRefetch().then((e) => {
                    toastSuccess("Success Edit Experience!", 'top-right', 'colored')
            ...
            <div className='modal-content'>
                ...
                <div className='modal-content__content-container'>
                    ...
                    <div className='button-container'>
                        <button className='button-submit' onClick={handleExperienceUpdate}>Update</button>
                    </div>
                </div>
            </div>
...
export default ExperienceModalEdit