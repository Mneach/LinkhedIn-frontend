...
import { mutationUpdateEducation } from '../../../lib/graphql/UpdateQuery'
import { toastError, toastSuccess } from '../../../lib/toast/toast'
import { enumMonthType, setBoolean } from '../../../model/FormModel'
import { EducationType } from '../../../model/model'

const EducationModalEdit = ({ modalEducation, setModalEducation, educationUser }: { modalEducation: boolean, setModalEducation: setBoolean, educationUser: EducationType }) => {


    const UserContext = useUserContext()
    const [educationUpdateMutation, { loading, error, called }] = useMutation(mutationUpdateEducation)

    const [educationData, setEducationData] = useState({
        id: educationUser.id,
        userId: UserContext.User.id,
        school: educationUser.school,
        degree: educationUser.degree,
        fieldStudy: educationUser.fieldStudy,
        grade: educationUser.grade,
        activities: educationUser.activities,
        description: educationUser.description,
        monthStartDate: educationUser.monthStartDate,
        monthEndDate: educationUser.monthEndDate,
        yearStartDate: educationUser.yearStartDate,
        yearEndDate: educationUser.yearEndDate,
    })
        ...
        if (!error) {
            if (called && !loading) {
                UserContext.userRefetch().then((e) => {
                    toastSuccess("Success Update Education!", 'top-right', 'colored')
            ...
            <div className='modal-content'>
                ...
                <div className='modal-content__content-container'>
                    ...
                    <div className='button-container'>
                        <button className='button-submit' onClick={handleEducationAdd}>Update</button>
                    </div>
                </div>
            </div>
