...
const MentionHover = ({ text }: { text: string }) => {
    ...
    return (
        ...
        <Link className="richText-a" onMouseOver={() => setModalMention(true)} onMouseLeave={() => setModalMention(false)} to={`/mainPage/profile/${userIdSubString}`}>{mentionTagSubString} &nbsp;</Link>
        </span>
    )
}
