...
const MessageMyVideoCall = ({ videoCallData }: { videoCallData: VideoCallType }) => {
  ...
  return (
    <div className='my-video-call-container'>
      <div className='my-video-call-left-container'>
        <BsCameraVideo size={25} />
      </div>
      <div className="my-video-call-right-container">
...
export default MessageMyVideoCall